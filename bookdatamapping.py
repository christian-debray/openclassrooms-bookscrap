...
class BookDataMapping:
    """
    static class holding mappings to extract book data from an HTML doc on https://books.toscrape.com/
    ...
    universal_product_code_selector = "#content_inner > article.product_page .table > tr:nth-child(1) > td:nth-child(2)"
    price_including_tax_selector = "#content_inner > article.product_page .table tr:nth-child(4) > td"
    price_excluding_tax_selector = "#content_inner > article.product_page .table tr:nth-child(3) > td"
